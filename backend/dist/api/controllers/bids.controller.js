...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, item, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                payload = req.body;
                return [4 /*yield*/, items_model_1.Item.create(payload)];
            case 1:
                item = _a.sent();
                return [2 /*return*/, res.status(201).send({ status: true, message: "Item created successfully.", item: item })];
            case 2:
                error_1 = _a.sent();
                next(error_1);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                payload = req.body;
                return [4 /*yield*/, items_model_1.Item.updateOne({ _id: mongoose_1.Types.ObjectId(req.params.id) }, { $set: payload })];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
